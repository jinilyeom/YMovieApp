...
# the corresponding class or field is matches by a `-keep` rule as well, see https://r8.googlesource.com/r8/+/refs/heads/main/compatibility-faq.md#r8-full-mode
...
# If classes with fields annotated with @SerializedName have a no-args constructor keep that as well.
